...
class Blackboard:
    ...
    def save(self, path: str | Path) -> None:
        ...
        data = {
            ...
            "validation_summary": self.validation_report.get("summary", {}),
    ...
    def load(cls, path: str | Path) -> "Blackboard":
        ...
        try:
            ...
            bb.validation_report = {"summary": data.get("validation_summary", {})}
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "validation_high_flags": self.validation_report.get("summary", {}).get("high", 0),
